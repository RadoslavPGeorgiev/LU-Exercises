...
public class App {
    public static void main(String[] args)
    {
        ...
        Book book1 = new Book("2", "The Brothers Karamazov", "Fyodor Dostoevsky");
        Book book2 = new Book("3", "War and Peace", "Leo Tolstoy");
        Book book3 = new Book("4", "Pride and Prejudice", "Jane Austen");
